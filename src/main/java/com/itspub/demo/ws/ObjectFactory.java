 ...
 * generated in the com.itspub.demo.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldResponse_QNAME = new QName("http://ws.demo.itspub.com/", "sayHelloWorldResponse");
    private final static QName _SayHelloWorld_QNAME = new QName("http://ws.demo.itspub.com/", "sayHelloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.itspub.demo.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.demo.itspub.com/", name = "sayHelloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.demo.itspub.com/", name = "sayHelloWorld")
